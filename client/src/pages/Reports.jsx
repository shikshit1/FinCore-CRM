          ...
          <div className="fincore-content">
            ...
            {loading ? (
              <div className="fincore-card p-8 text-center">
                ...
                <p className="mt-4 text-gray-600 dark:text-slate-400">Loading report data...</p>
              </div>
            ) : (
              <>
                {/* KPI Cards */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
                  {reportCards.map((card, index) => {
                    ...
                    return (
                      <div key={index} className="fincore-card hover:shadow-lg transition p-6">
                        ...
                        <p className="text-gray-600 dark:text-slate-400 text-sm mb-1">{card.title}</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                      ...
                      {[
                        ...
                        <div key={idx}>
                          <div className="flex justify-between mb-2">
                            ...
                            <span className="text-sm font-bold text-gray-900 dark:text-slate-100">{item.value}%</span>
                          </div>
                  ...
                  {/* Monthly Growth */}
                  <div className="fincore-card p-6">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-slate-100 mb-6">Monthly Growth</h3>
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={idx} className="flex items-center justify-between">
                          <span className="text-sm font-medium text-gray-700 dark:text-slate-300 w-12">{item.month}</span>
                    ...
                    <div className="mt-4 flex gap-4 text-xs">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-600 dark:text-slate-400">Loans</span>
                      </div>
                      <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  <div className="fincore-card p-6">
                    <p className="text-gray-600 dark:text-slate-400 text-sm mb-2">Customer Retention</p>
                    <p className="text-3xl font-bold text-gray-900 dark:text-slate-100">92%</p>
